...
ColorSkinWndFrame::ColorSkinWndFrame(MainWndFrame* main_frame, RECT rcParentWindow)
...
LPCTSTR ColorSkinWndFrame::GetWindowClassName() const
{
	return _T("ColorSkinWndFrame");
}

void ColorSkinWndFrame::OnFinalMessage(HWND hWnd)
{
	WindowImplBase::OnFinalMessage(hWnd);
	delete this;
}

void ColorSkinWndFrame::Notify(TNotifyUI& msg)
{
...
void ColorSkinWndFrame::InitWindow()
{
...
CDuiString ColorSkinWndFrame::GetSkinFile()
{
	return _T("ColorWnd.xml");
}

CDuiString ColorSkinWndFrame::GetSkinFolder()
{
	return _T("theme\\");
}

LRESULT ColorSkinWndFrame::OnKillFocus(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	Close();
	return 0;
}
